...
@Getter
@Setter
public class SearchPracticeRequestDTO implements Serializable {

	private static final long serialVersionUID = -8667875275028390057L;

	private String fiscalCodeAgency;
