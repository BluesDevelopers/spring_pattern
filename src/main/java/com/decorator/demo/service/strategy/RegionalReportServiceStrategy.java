...
@Service("regionalReportServiceStrategy")
public class RegionalReportServiceStrategy implements IReportServiceStrategy {

	@Override
	public ByteArrayOutputStream exportExcel(ReportFilterDTO filter) {
		System.out.println("Call exportExcel of RegionalReportServiceStrategy");
		return null;
	}

	@Override
	public List<ReportDTO> searcher(ReportFilterDTO filter) {
		System.out.println("Call searcher of RegionalReportServiceStrategy");
		return null;
	}
