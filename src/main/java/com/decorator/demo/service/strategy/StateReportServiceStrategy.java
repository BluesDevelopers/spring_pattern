...
@Service("stateReportServiceStrategy")
public class StateReportServiceStrategy implements IReportServiceStrategy {

	@Override
	public ByteArrayOutputStream exportExcel(ReportFilterDTO filter) {
		System.out.println("Call exportExcel of StateReportServiceStrategy");
		return null;
	}

	@Override
	public List<ReportDTO> searcher(ReportFilterDTO filter) {
		System.out.println("Call searcher of StateReportServiceStrategy");
		return null;
	}
