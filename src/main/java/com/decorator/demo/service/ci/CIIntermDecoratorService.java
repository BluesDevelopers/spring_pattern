...
@Service("ciIntermDecoratorService")
public class CIIntermDecoratorService extends CIPracticeBaseDecoratorService {

	public CIIntermDecoratorService(@Qualifier("ciPracticeBaseDecoratorService") IPracticesService ciPracticeService) {
	...
	public PracticeDTO updatePractice(PracticeDTO praticaDTO) {
		System.out.println("Call updatePractice of ciIntermDecoratorService");		
		return new PracticeDTO();
	}

	@Override
	public void archivePractice(Long idPractice) {
		System.out.println("Call archivePractice of ciIntermDecoratorService");		
	...
	public PracticeDTO saveDraft(PracticeDTO practiceDTO) {
		System.out.println("Call saveDraft of ciIntermDecoratorService");		
		return new PracticeDTO();
	}
	...
	public Boolean deleteDraft(Long id) {
		System.out.println("Call deleteDraft of ciIntermDecoratorService");				
