...
@Service("ciCompanyDecoratorService")
public class CICompanyDecoratorService extends CIPracticeBaseDecoratorService {

	public CICompanyDecoratorService(@Qualifier("ciPracticeBaseDecoratorService") IPracticesService ciPracticeService) {
	...
	public PracticeDTO updatePractice(PracticeDTO praticaDTO) {
		System.out.println("Call updatePractice of ciCompanyDecoratorService");		
		return new PracticeDTO();
	}

	@Override
	public void archivePractice(Long idPractice) {
		super.archivePractice(idPractice);
	...
	public PracticeDTO saveDraft(PracticeDTO practiceDTO) {
		System.out.println("Call saveDraft of ciCompanyDecoratorService");		
		return new PracticeDTO();
	}
